...
const Profile: React.FC = () => {
    ...
    return (
        <div
            className="min-h-screen py-8 px-8 pl-64 bg-gray-50"
        >
            <div className="max-w-7xl relative z-0">
                {/* Header Navigation */}
                <nav className="flex items-center justify-between mb-8">
                    <Link
                        to="/dashboard"
                        className="flex items-center space-x-2 text-[#535F80] hover:text-[#051747] transition-all duration-300 font-medium hover:scale-105 hover:shadow-[0_8px_20px_rgba(30,64,175,0.3)] px-3 py-2 rounded-lg"
                    >
                        ...
                        <div className="relative group/card">
                            ...
                            <div className="bg-white/90 backdrop-blur-lg border border-white/60 rounded-2xl shadow-xl p-8 hover:shadow-[0_25px_60px_rgba(59,130,246,0.5)] hover:bg-blue-100 transition-all duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-[#535F80] mb-2">Phone Number</label>
                                        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg px-4 py-3 text-[#051747] font-medium">
                                            {userData.phone}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-[#535F80] mb-2">Location</label>
                                        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg px-4 py-3 text-[#051747] font-medium">
                                            {userData.location}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-[#535F80] mb-2">Job Title</label>
                                        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg px-4 py-3 text-[#051747] font-medium">
                                            {userData.jobTitle}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-[#535F80] mb-2">Company</label>
                                        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg px-4 py-3 text-[#051747] font-medium">
                                            {userData.company}
                                        </div>
                                    </div>
                                ...
                                <div className="mt-6">
                                    <label className="block text-sm font-semibold text-[#535F80] mb-2">Bio</label>
                                    <div className="bg-blue-50 border-2 border-blue-300 rounded-lg px-4 py-3 text-[#051747] min-h-[100px] font-medium">
                                        {userData.bio}
                                    </div>
                                </div>
                            </div>
